  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-4 col-md-6 service-item">
        <a wire:navigate class="" href="{{ route('Service-detail',$services->id) }}">
          <div class="block"> <span class="colored-box text-center h3 mb-4">0{{ $x++ }}</span>
            <h3 class="mb-3 service-title">{{  $services->title }}</h3>
            <p class="mb-0 service-description">{{ $services->short_desc }}</p>
          </div>
        </a>
      </div>
        @endforeach
